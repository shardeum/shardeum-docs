...
export default function Home() {
  return (
    <div className="bg-gray-50 py-14 sm:py-18">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-7xl">
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-16">
            {features.map((feature) => (
              <a key={feature.name} href={feature.link} className="relative border border-gray-300 rounded-lg p-6 flex flex-col items-center text-center transition-transform duration-300 hover:shadow-lg hover:scale-105 hover:border-indigo-500">
