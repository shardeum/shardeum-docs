...
description: Shardeum - An EVM-compatible L1 smart contract platform
---

Shardeum is an EVM-compatible Layer 1 blockchain network that enables developers and businesses to build programmable onchain applications, including real-world asset tokenization, stablecoins, payments, marketplaces, and DeFi.
...
**SHM** is the native token and ticker symbol of Shardeum. It powers multiple use-cases including, paying gas fees, staking, community rewards, among other use cases - all of which contribute to the network’s security and overall utility.

Key features include:

1. **EVM smart contract compatibility** enabling developers to build applications using familiar EVM standards, Solidity, wallets, and Ethereum-compatible tooling.
2. **Proof-of-Stake consensus with delegated staking** and fast finality, ensuring efficiency and security.
3. **Low fees and high throughput** benefitting both developers and end-users.
4. **Modular architecture** designed to support further performance and scalability enhancements as the network evolves.
5. **Permissionless access**: Any genuine participant – individual or enterprise, Web2 or Web3 – can build and transact freely without gatekeepers and at negligible cost.
