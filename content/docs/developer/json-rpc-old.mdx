...
For information on the RPC endpoint for the live network, visit [Shardeum Network Endpoints](/docs/overview/endpoints) or use the RPC endpoint for our beta network or local development version.
