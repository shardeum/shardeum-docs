...
description: Learn about the ERC-721 token standard on Shardeum
---
...
And follow these [instructions](https://docs.shardeum.org/docs/faucet/claim) to add Shardeum to MetaMask wallet and claim test 100 $SHM tokens from the faucet.
...
```
SHARDEUM_RPC=https://api-unstable.shardeum.org/
...
## Step 13 : Deploy to Shardeum testnet
...
If we go to the suitable active Shardeum explorers listed below and search for contract address and you should be able to see it there!

[Shardeum Mainnet Explorer](https://explorer.shardeum.org/)

[Shardeum Unstablenet Explorer](https://explorer-unstable.shardeum.org/)

[Shardeum Testnet Explorer](https://explorer-testnet.shardeum.org/)
