...
<Cards>
  <Card
    href="/docs/node/run/validator/setup/self-host"
    title="Self Host"
    description="You have experience running servers"
  />
  <Card
    href="/docs/node/run/validator/setup/one-click-install"
    title="1-Click Install"
    description="You have little to no experience running servers"
  />
  <Card
    href="/docs/node/run/validator/setup/cloud-service-providers"
    title="Cloud Service Providers"
    description="You want to use a hosted service like GCP, AWS, etc."
  />
  <Card
    href="/docs/node/run/validator/node-states"
    title="Validator Node States"
    description="Understand the different states of a validator node"
  />
</Cards>
