...
description: Shardeum Documentation
---
...
* [Shardeum Node Types](/docs/ecosystem/node-types)

Running nodes:

* [How to run a validator node](/docs/run-a-node/self-host)
...
* [ERC-20 (Fungible Tokens)](/docs/smart-contracts/tokens/erc-20)
* [ERC-721 (NFTs)](/docs/smart-contracts/tokens/erc-721)
* [ERC-1155 (Token Emulator)](/docs/smart-contracts/tokens/erc-1155)
...
* [EIP-2930 Overview](/docs/smart-contracts/eip-2930/multicall-contract)
...
* [IPFS and Filecoin](/docs/storage/ipfs-and-filecoin)

## Oracles on Shardeum

Get off chain data securely on Shardeum using oracle providers.

* [SupraOracles](/docs/oracles/supraoracles)
