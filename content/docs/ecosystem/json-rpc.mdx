...
If you don't want to host your own server, you can connect to the public Shardeum RPC endpoints. This is ideal for most developers and contributors. Visit [this page](https://docs.shardeum.org/docs/developer/network-and-rpc) for the latest network details.
