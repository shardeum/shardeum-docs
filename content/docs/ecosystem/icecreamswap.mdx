...
## Integrating Token Swaps with the Nordstern.Finance Aggregator API
...
The Nordstern Aggregator API acts as a unified entry point to Shardeum's DEX liquidity.
