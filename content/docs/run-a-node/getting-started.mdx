...
<Cards>
  <Card
    href="/docs/node/run-a-node/validator/setup/self-host"
    title="Self Host"
    description="You have experience running servers"
  />
  <Card
    href="/docs/node/run-a-node/validator/setup/one-click-install"
    title="1-Click Install"
    description="You have little to no experience running servers"
  />
  <Card
    href="/docs/node/run-a-node/validator/setup/cloud-service-providers"
