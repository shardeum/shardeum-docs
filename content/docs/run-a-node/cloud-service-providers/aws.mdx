...
4. Configure your instance:
   ...
   - Under "Instance Type":
     - Select an instance that [meets minimum requirements](/docs/run-a-node/self-host#minimum-hardware-requirements)
...
Once your AWS instance is ready, follow our [Base Guide for Running a Shardeum Validator Node](/docs/run-a-node/validator/setup/self-host) for detailed installation instructions, including the steps to open the validator dashboard, stake SHM, start the validator, and more.
