...
2. Select a plan that meets the [minimum requirements](/docs/run-a-node/self-host#minimum-hardware-requirements)
3. Choose:
...
Once your VPS is ready, follow our [Base Guide for Running a Shardeum Validator Node](/docs/run-a-node/validator/setup/self-host) for detailed installation instructions, including the steps to open the validator dashboard, stake SHM, start the validator, and more.

## Resources

- [Blog Tutorial](https://shardeum.org/blog/run-shardeum-validator-node-contabo/)
