...
- **RAM:** 16GB
- **Storage:** 1TB NVMe SSD (recommended for mainnet)
...
```bash
NODE_ID="<validator-id>"  # node0, node1, shardeumnode
...
```bash
shardeumd init "$MONIKER" --chain-id shardeum_8118-1 --home $HOME/.mainnet/$NODE_ID --overwrite
```
...
```bash
shardeumd start --home $HOME/.mainnet/$NODE_ID --chain-id shardeum_8118-1 --p2p.seeds a6b7640991e0d5070dc99ecc07f969275a130045@34.93.254.18:27656,d04dd653ff79799263f1bd1df8ce61071d798880@34.31.69.40:27656 --p2p.laddr tcp://0.0.0.0:27656 --rpc.laddr tcp://127.0.0.1:26657 --pruning nothing > $HOME/.mainnet/$NODE_ID/node.log
```
...
**To restore an existing key instead, use:**
...
## 9. Fund Validator Account

Your validator account must have enough SHM to complete the staking transaction.
