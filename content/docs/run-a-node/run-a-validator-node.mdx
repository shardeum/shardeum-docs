...
**Fetch the latest release tags and check out the supported mainnet release:**
...
Validator showing `jailed: true`? See [Unjailing a Validator](/docs/run-a-node/advanced-operations#unjailing-a-validator)
