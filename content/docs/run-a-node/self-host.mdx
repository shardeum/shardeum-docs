...
Connect to Shardeum Validator with your wallet by adding the network with the network details [here](/docs/network/endpoints).

## Get SHM

Get SHM Tokens from available on exchanges by visiting https://shardeum.org/get-shm/
