...
- Minimum staking amount required to run a node on Shardeum currently is 2400 SHM
...
## Connect Wallet to Shardeum Mainnet

Connect to Shardeum Validator with your wallet by adding the mainnet network configuration here https://docs.shardeum.org/docs/network/endpoints

## Get SHM

Get SHM tokens from supported exchanges by visiting https://shardeum.org/get-shm/
...
This example has filled in 10 SHM tokens to stake for testing.


<Callout title="" type="info">

Stake the specified minimum amount to start earning rewards. (It is 2400 SHM currently on mainnet)
...
<Callout title="" type="info">
Active nodes earn rewards based on their time in the active set, while standby nodes do not. Standby nodes support scalability and may rotate into the active set based on network demand. You can learn more SHM Tokenomics here: https://docs.shardeum.org/docs/whitepaper#36-tokenomics-policy
</Callout>
