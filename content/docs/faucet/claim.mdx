...
This faucet is only for claiming testnet SHM tokens. It will not work for mainnet SHM. Testnet tokens have no monetary value and are only for testing purposes.
</Callout>
