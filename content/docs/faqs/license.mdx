...
2.  A statement of the percentage of the maximum supply of Shardeum network coins allocated to be claimed by Shardus token (ULT) holders. We have chosen to allocate 1% (the minimum required) of the 249 million maximum supply of coins on the Shardeum network.
