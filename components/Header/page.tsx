...
import { ChevronDownIcon, DocumentIcon, PlayCircleIcon, CodeBracketIcon, ChatBubbleBottomCenterIcon, AcademicCapIcon, VideoCameraIcon, GlobeAltIcon } from '@heroicons/react/20/solid'
...
const navItems = [
    ...
    { name: 'Claim Testnet SHM', href: '/docs/faucet' },
]
            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="/" className="-m-1.5 p-1.5">
                        ...
                        <img className="h-8 w-auto" src="shardeum_documentation_dark.png" alt="" />
                    </a>
                </div>
